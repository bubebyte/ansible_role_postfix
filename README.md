...
postfix_sql_map_configuration:
  "SQL configuration":
    virtual_mailbox_domains: "{{ postfix_sql_backend }}:/etc/postfix/sql_map/virtual_domains.cf"
    virtual_mailbox_maps: "{{ postfix_sql_backend }}:/etc/postfix/sql_map/virtual_mailbox_recipients.cf"
    virtual_alias_maps: "{{ postfix_sql_backend }}:/etc/postfix/sql_map/virtual_mailbox_aliases.cf"
